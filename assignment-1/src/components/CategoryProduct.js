...
import OrderByQueryParam from "./OrderByQueryParam";
...
const productBest = [
    { id: 1, productTitle: "Tolrae Relaxed Skirt", tierPrice: "Rp. 430.000", price: "Rp. 420.000", imgSrc: ImgProduct2},
    { id: 2, productTitle: "Blazer Knit Wear", tierPrice: "Rp. 230.000", price: "Rp. 200.000", imgSrc: ImgProduct1},
    { id: 3, productTitle: "Blazer Charli Relaxed", tierPrice: "Rp. 920.000", price: "Rp. 210.000", imgSrc: ImgProduct4},
    { id: 4, productTitle: "Gingham Blazer Dress", tierPrice: "Rp. 300.000", price: "Rp. 110.000", imgSrc: ImgProduct5},
    { id: 5, productTitle: "Skirt Mignon Printed", tierPrice: "Rp. 340.000", price: "Rp. 240.000", imgSrc: ImgProduct1},
    { id: 6, productTitle: "Pinstripe Dress Amayn", tierPrice: "Rp. 510.000", price: "Rp. 190.000", imgSrc: ImgProduct2},
    { id: 7, productTitle: "Amayn Pinstripe Dress", tierPrice: "Rp. 300.000", price: "Rp. 150.000", imgSrc: ImgProduct1},
    { id: 8, productTitle: "Tolrae Gingham Sleeve", tierPrice: "Rp. 350.000", price: "Rp. 250.000", imgSrc: ImgProduct2},
    { id: 9, productTitle: "Mignon Printed Skirt", tierPrice: "Rp. 350.000", price: "Rp. 170.000", imgSrc: ImgProduct3},
    { id: 10, productTitle: "Charli Relaxed Blazer", tierPrice: "Rp. 400.000", price: "Rp. 210.000", imgSrc: ImgProduct4}
]
